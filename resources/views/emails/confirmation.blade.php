                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                        ...
                                        <tr>
                                            <td style="width:550px;">
                                                <img height="auto" src="" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="550" />
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                            ...
                                            <td style="direction:ltr;font-size:0px;padding:0px;text-align:center;">
                                                ...
                                                <div class="mj-column-per-75 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                <div style="font-family:Roboto, Helvetica, sans-serif;font-size:16px;font-weight:300;text-align:left;color:#616161;">
                                                                    ...
                                                                    <p style="font-size: 14px">Direction : <b>{{ $reservation->returnReservation ? 'Round Trip' : 'One Way' }}</b> </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                <div style="font-family:Roboto, Helvetica, sans-serif;font-size:14px;font-weight:400;line-height:24px;text-align:left;">
                                                                    <b>Important notes on your transfer reservation, modifications and cancellations:</b>

                                                                    <br>

                                                                    <small>Please have your reservation ready to show to your driver (via mobile phone or printed version) in order to reconfirm you have arrived to the right transfer as scheduled and reserved.</small>
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                <div style="font-family:Roboto, Helvetica, sans-serif;font-size:14px;font-weight:400;text-align:left;">
                                                                    <ul>
                                                                        <li style="padding-bottom: 20px"><strong>Pick-up time and meeting point: </strong> <br>
                                                                            Airport pick up time and meeting point on arrival: the driver will be waiting outside
                                                                            the baggage claim area at the gate assigned to the specified flight number, holding a
                                                                            pickup sign with passenger name. Time frame refers to the waiting time when flight is
                                                                            on schedule. In case of delays, waiting time is prolonged accordingly. In case you cannot
                                                                            identify your transfer at the designated location, please contact !!!!rezervacijski centar e-mail i broj telefona!!!
                                                                        </li>

                                                                        <li style="padding-bottom: 20px"><strong>Hotel pick up time and meeting point on departure:</strong><br>
                                                                            - Hotel pick up time and meeting point on departure: timing of return transfer may be adjusted according to road conditions.
                                                                            Please reconfirm your pick up time and meeting point at the reception the day before the departure. <br>
                                                                            - Kindly plan to arrive at least 10 minutes before your transfer departure time.
                                                                        </li>

                                                                        <li style="padding-bottom: 20px"><strong>In case you need to modify or cancel your booking before travel: </strong> <br>
                                                                            Please contact rezervacijski centar e-mail i broj telefona.
                                                                        </li>

                                                                        <li style="padding-bottom: 20px"><strong>In case of cancellation, a standard cancellation policy applies as follows:</strong> <br>
                                                                            Raspisat ćemo kako imaju partneri, u smislu cancellations are free of charge up to 24 hours before the .</li>

                                                                        <li style="padding-bottom: 20px"><strong>Please respect the following rules in the vehicle: </strong> <br>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            <tr>
                                <td align="center" style="font-size:0px;padding:0px 20px;word-break:break-word;">
                                    <div style="font-family:Arial, sans-serif;font-size:11px;line-height:22px;text-align:center;color:#55575d;">This is not fiscalized invoice.</div>
                                </td>
                            </tr>
                            </tbody>
                        </table>
